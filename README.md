# MetaEdit+ generator to export models in Markdown

Generators exports a model made with any domain-specific language from MetaEdit+ to Markdown markup language. Content is similar as RTF/Word and HTML generators.
